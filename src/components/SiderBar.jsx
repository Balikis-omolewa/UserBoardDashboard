      ...
      <Nav defaultActiveKey="/home" className="flex-column">
        ...
        <div className="sidebar-footer">
          <div className="user-info">
            <img src="https://gomycodelearn.blob.core.windows.net/profiles/89ed952c-2b13-401c-9b78-3610aaf1abb5-133591237293027357.jpg" alt="User" className="user-image"/>
            <div className="user-details">
              <span className="user-name">Balikis Omolewa</span>
              <span className="user-email">omolewabalikis149@gmail.com</span>
            </div>
          </div>
